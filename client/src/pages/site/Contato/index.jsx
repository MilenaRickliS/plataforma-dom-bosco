...
export default function Contato() {
  return (
    <div className="page">
        ...
        <main>
          <h1>Contato</h1>
          <p>Tem alguma dúvida ou sugestão.<br/>Entre em contato conosco agora mesmo!</p>
          <div>
            <div>
              <div>
                <FaPhone />
              ...
              <div>
                <MdEmail />
                <p>contatos@dombosco.net</p>
              </div>
              <div>
                <IoIosPin />
                <p>R. Padre Caetano Vendrami, 303 - Vila Carli, Guarapuava - PR, 85040-050</p>
              </div>
            </div>
